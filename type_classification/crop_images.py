...
with open('/Users/deregowskis/Desktop/work/jsw/export') as f:
    for line in f:
        image_name = line.strip('{"imageGcsUri":"gs://wozy_jsw/').split('","',1)[0]
        truck_json = line.strip('{"imageGcsUri":"gs://wozy_jsw/'+image_name+'","boundingBoxAnnotations":').split("]",1)[0]+']'
...
for truck in crop_list:
    ...
    im = Image.open('/Users/deregowskis/Desktop/work/jsw/photos/input/'+truck[0])
    ...
    cropped_im.save('/Users/deregowskis/Desktop/work/jsw/photos/cropped/'+truck[0].strip('.png')+'_'+''.join(random.choice(string.ascii_uppercase + string.ascii_lowercase + string.digits) for _ in range(5))+'.png')